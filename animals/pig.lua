...
minetest.register_node("ccmobs:pig_block", {
	...
	node_box = {
		type = "fixed",
		fixed = {
			{-0.125, -0.3125, 0.375, 0.125, -0.0625, 0.5},
			{-0.1875, -0.375, 0.0625, 0.1875, 0, 0.375},
			{-0.25, -0.125, 0.0625, 0.25, -0.0625, 0.1875},
			{-0.25, -0.4375, -0.4375, 0.25, 0.0625, 0.125},
			{-0.1875, -0.5, -0.0625, -0.0625, -0.4375, 0.0625},
			{0.0625, -0.5, -0.0625, 0.1875, -0.4375, 0.0625},
			{0.0625, -0.5, -0.375, 0.1875, -0.4375, -0.25},
			{-0.1875, -0.5, -0.375, -0.0625, -0.4375, -0.25},
			{-0.0139176, -0.1875, -0.470884, 0.0361858, -0.0472661, -0.4375},
			{-0.100207, -0.1875, -0.470884, 0.032117, -0.144579, -0.4375},
			{-0.109577, -0.147359, -0.470884, -0.073681, -0.090581, -0.437013},
		},
	},
...
mobs:register_mob("ccmobs:pig", {
	type = "animal",
	hp_max = 4,
	collisionbox = {-0.25, -0.3525, -0.35, 0.25, 0.25, 0.35},
	visual = "wielditem",
